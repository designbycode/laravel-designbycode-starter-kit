 ...
 * @route '/livewire-1c8181cb/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-1c8181cb/upload-file',
 ...
 * @route '/livewire-1c8181cb/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-1c8181cb/preview-file/{filename}',
