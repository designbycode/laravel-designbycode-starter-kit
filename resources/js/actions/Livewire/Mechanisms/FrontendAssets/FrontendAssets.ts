 ...
 * @route '/livewire-1c8181cb/livewire.js'
 */
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-1c8181cb/livewire.js',
 ...
 * @route '/livewire-1c8181cb/livewire.min.js.map'
 */
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-1c8181cb/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/livewire-1c8181cb/livewire.csp.min.js.map'
 */
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-1c8181cb/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
